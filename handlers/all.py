...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/rambo_syr")],[InlineKeyboardButton("تواصل المطور 💬", url="t.me/ramixnxx_bot")],[InlineKeyboardButton("مطور البوت", url="t.me/nnnnh")]])

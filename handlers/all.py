...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/RAMBO_SYR")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/ramixnxx_bot")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/RAMBO_SYR")]])
